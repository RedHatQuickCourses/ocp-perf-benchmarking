...
execute_init()
{
	...
	sed -i "s/ocp-perf-benchmarking/${REPONAME}/g" *.* > /dev/null 2>&1
	sed -i "s/ocp-perf-benchmarking/${REPONAME}/g" supplemental-ui/partials/header-content.hbs > /dev/null 2>&1
	echo -e "done"
