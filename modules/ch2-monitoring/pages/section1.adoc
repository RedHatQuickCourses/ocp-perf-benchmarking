...
worker-cluster-vjm62-2          2734m        15%         8438Mi          29%
----
...
image::prom-dashboard.png[width=700]
...
.Prometheus Targets
image::prom-targets.png[width=700]
...
image::prom-query.png[width=700]

Useful PromQL queries you may try:
