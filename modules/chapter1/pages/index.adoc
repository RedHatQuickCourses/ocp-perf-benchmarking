...
* link:https://docs.redhat.com/en/documentation/openshift_container_platform/3.11/html-single/scaling_and_performance_guide/index[OpenShift Scaling and Performance Guide,window=_blank]